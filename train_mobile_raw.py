...
import raw_flops_benchmark
from raw_clr import CyclicLR
from raw_data import get_loaders
from raw_logger import CsvLogger
from raw_run import train, test, save_checkpoint, find_bounds_clr
from models import *
...
parser.add_argument('--results_dir', metavar='RESULTS_DIR', default='./results_v1', help='Directory to store results')
...
def main():
    ...
    model = Darknet('cfg/mobile.cfg').to(device)
    num_parameters = sum([l.nelement() for l in model.parameters()])
    print(model)
    print('number of parameters: {}'.format(num_parameters))
    '''
    print('FLOPs: {}'.format(
        raw_flops_benchmark.count_flops(Darknet('cfg/mobile-net.cfg'),
